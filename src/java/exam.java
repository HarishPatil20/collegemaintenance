    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           try{
               ...
               stat1.executeUpdate("INSERT INTO `exam` (`id`, `regno`, `scode`, `maxmarks`, `obtainedmarks`) VALUES (NULL, '"+regno1+"', '"+scode+"', '"+maxmarks+"', '"+obtainedmarks+"');");
               out.println("<script>alert(\"EXAM MARKS ADDED\")</script>");
               out.println("<meta http-equiv='refresh' content='0;exam.jsp'/>");          
                }
           catch(Exception e){
               out.println(e);
               out.println("<script>alert(\"REGISTER NUMBER AND SUBJECT MARKS ALREADY ADDED\")</script>");
               out.println("<meta http-equiv='refresh' content='0;exam.jsp'/>");
           }                
        }
                else{
