               ...
               <h3 class="text-primary" style="margin-left: auto;margin-right:auto">EXAM <span style="color: black">ALLOTMENT</span></h3>                                
                    ...
                    <div>
                     ...
                     try{
                         ...
                         ResultSet res=stat.executeQuery("SELECT * FROM examallotment");
                         while(res.next())
                         {                        
                        
                         String id=res.getString("id");        
                         String scode=res.getString("scode");
                         String rno=res.getString("roomno");
                         String fid=res.getString("fid");
                         String date=res.getString("date");
                         String time=res.getString("time");
                          out.println("<tr><td>"+id+"</td><td>"+scode+"</td><td>"+rno+"</td><td>"+fid+"</td><td>"+date+"</td><td>"+time+"</td><td><a href=deleteexamallotment?id="+id+">DELETE</a></td></tr>");
                            }
                         con.close();
                          }
                          catch(Exception e)
