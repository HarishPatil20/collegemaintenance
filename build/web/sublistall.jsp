    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
           ...
           <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">                
                ...
                <h3 class="text-primary" style="margin-left: auto;margin-right:auto">SUBJECT'S <span style="color: black">LIST</span></h3>                               
                       </div>                                        
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                while(res.next()){
                    ...
                    String sem=res.getString("sem");     
                          out.println("<tr><td>"+slno+"</td><td>"+scode+"</td><td>"+sname+"</td><td>"+bid+"</td><td>"+sem+"</td><td><a href=deletesubject?id="+scode+">DELETE</a></td></tr>");                           
