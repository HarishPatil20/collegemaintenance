    ...
    <div class="container-xxl position-relative bg-white d-flex p-0" >
        ...
        <div class="content" >
            ...
            <!-- Navbar End -->
                ...
                <h3 class="text-primary" style="margin-left: auto;margin-right:auto">CIRCULAR</h3>                               
                       </div>                    
                    <div>
                        <table id="customers">
                            <thead>
                     ...
                     try{
                         ...
                         ResultSet res=stat.executeQuery("SELECT * FROM circular");
                         while(res.next())
                         {                        
                         ...
                         String filepath=res.getString("filepath");
                          out.println("<tr><td>"+id+"</td><td>"+date+"</td><td><a target='_blank' href='files/"+filepath+"'>Download</a></td><td><a href=deletecircular?id="+id+">DELETE</a></td></tr>");
                            }
                         con.close();
                          }
                          catch(Exception e)
