        ...
        <div class="content">
            ...
            <!-- Navbar End -->
                     ...
                     <div class="d-flex " style="padding: 20px">                          
                         <h3 class="text-primary" style="margin-left: auto;margin-right:auto">IA <span style="color: black">MARKS</span></h3>                               
                       </div>
...
try {
    ...
    ResultSet res=stat.executeQuery("SELECT * FROM iamarks");
    while(res.next()) {                        
        String id=res.getString("id");
        String regno=res.getString("regno");
        String scode=res.getString("scode");
        String maxmarks=res.getString("maxmarks");
        String obtainedmarks=res.getString("obtainedmarks");
        int max=Integer.parseInt(maxmarks);
        float ob=Integer.parseInt(obtainedmarks);
        float per = ( ob / max) * 100; 
        out.println("<tr><td>"+id+"</td><td>"+regno+"</td><td>"+scode+"</td><td>"+maxmarks+"</td><td>"+obtainedmarks+"</td><td>"+per+"</td><td><a href=deleteiamarks?id="+id+">DELETE</a></td></tr>");
    }
    con.close();
} catch(Exception e) {
