        ...
        <div class="content">
            ...
            <!-- Navbar End -->
                     ...
                     <div class="d-flex " style="padding: 20px">                          
                         <h3 class="text-primary" style="margin-left: auto;margin-right:auto">EXAM <span style="color: black">STAFF</span> LIST</h3>                               
                       </div>
                    <div class="table-responsive">
                     ...
                     try{
                         ...
                         ResultSet res=stat.executeQuery("SELECT * FROM allotment");
                         while(res.next())
                         {                        
                        
                         String id=res.getString("id");
                         String batchcode=res.getString("batchcode");
                         String sem=res.getString("sem");
                         String bid=res.getString("bid");
                         String scode=res.getString("scode");
                         String fid=res.getString("fid");
                          out.println("<tr><td>"+id+"</td><td>"+batchcode+"</td><td>"+sem+"</td><td>"+bid+"</td><td>"+scode+"</td><td>"+fid+"</td><td><a href=deleteexamstaflist?id="+id+">DELETE</a></td></tr>");
                            }
                         con.close();
                          }
                          catch(Exception e)
