                ...
                <div class="navbar-nav w-100">
                     <a href="fhome.jsp" class="nav-item nav-link  "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>               
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="#" class="dropdown-item">Result Analysis</a>
                        </div>
                    </div>
            ...
            <!-- Form Start -->
             <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3"> 
                      <center>
                      <h3 class="text-primary">RESULT <span style="color: black">ANALYSIS</span></h3>
                      </center>
                            <form action="viewresult.jsp" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingSelect">Select semester</label><br>                                 
                            </div>   
                                    <center>
