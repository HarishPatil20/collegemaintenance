        ...
        <div class="content">
            ...
            <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3"> 
                         <center><h3 class="mb-4 text-primary"><b>CIRCULARS</b></h3></center>
                         <form action="circulars" method="POST">
                                ...
                                <div class="mb-3">
                                 ...
                                 <center><button type="submit" class="btn btn-primary">ADD</button>
                                         <button type="submit" class="btn btn-primary" ><a href="showcirculars.jsp" style="color: white;text-decoration: none">VIEW</a></button><br></center>
                                </div>
