        ...
        <div class="content">
            ...
            <!-- Navbar End -->
                     ...
                     <div class="d-flex " style="padding: 20px">                          
                         <h3 class="text-primary" style="margin-left: auto;margin-right:auto">EXAM <span style="color: black">MARKS</span></h3>                               
                       </div>
...
try {
    ...
    ResultSet res=stat.executeQuery("SELECT * FROM exam");
    while(res.next()) {                        
        ...
        out.println("<tr><td>"+id+"</td><td>"+regno+"</td><td>"+scode+"</td><td>"+maxmarks+"</td><td>"+obtainedmarks+"</td><td>"+per+"</td><td><a href=deleteexam?id="+id+">DELETE</a></td></tr>");
    }
    con.close();
} catch(Exception e) {
