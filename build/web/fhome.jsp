    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                 ...
                 <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Faculty</a>
                    ...
                    <%--  <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="showstudent.jsp" class="dropdown-item">Candidate List</a>
                            <a href="showstudent.jsp" class="dropdown-item">Time Table</a>
                            <a href="showstudent.jsp" class="dropdown-item">Exam Staff List</a>                          
                            <a href="circular.jsp" class="dropdown-item">Circulars</a>
                            <a href="showstudent.jsp" class="dropdown-item">Results</a>
                         
                        </div>
                    </div>
                         
                    <%--<div class="navbar-nav w-100">  
                    <a href="ahome.jsp" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>admin</a>
                    <a href="showstudent.jsp" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Candidate ListS</a>                     
                    <a href="#" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Exam Staff</a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Result</a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Time Table</a>
                     <a href="#" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Circular</a>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
          ...
          <div class="d-flex " style="padding: 20px">                          
                <h3 class="text-primary" style="margin-left: auto;margin-right:auto">SMP <span style="color: black">Sagar</span></h3>                               
            </div> 
