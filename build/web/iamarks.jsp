            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                     <a href="fhome.jsp" class="nav-item nav-link  "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>               
                        ...
                        <a href="#" class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Faculty</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="#" class="dropdown-item">IA Marks</a>
                   ...
                   <div class="navbar-nav align-items-center ms-auto">                  
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Facutly</span>
                        </a>
            ...
            <!-- Form Start -->
             <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3"> 
                      <center>
                      <h3 class="text-primary">IA <span style="color: black">MARKS</span></h3>
                      </center>
                            <form action="iamarks" method="POST">
                                <div class="mb-3">
                          ...
                          out.println("<option value="+scode+">"+sname+"("+scode+")</option>");                           
                                ...
                                <div class="mb-3">
                                    ...
                                    <center><button type="submit" class="btn btn-primary">ADD</button>
                                        <button type="submit" class="btn btn-primary" ><a href="viewiamarks.jsp" style="color: white;text-decoration: none">VIEW</a></button></center>  
