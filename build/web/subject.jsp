        ...
        <div class="content">
            ...
            <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3" style="width: 80%;margin-left: auto;margin-right: auto">
                <div class="d-flex " style="padding: 20px">                          
                         <h3 class="text-primary" style="margin-left: auto;margin-right:auto">SUBJECT'S</h3>                               
                       </div>
                            <form action="subject" method="POST">                               
                                <div class="mb-3">
                                    <label for="exampleInpusubjectname" class="form-label">Subject Code</label>
                                    <input type="text" name="scode" class="form-control" id="exampleInpusubjectcode" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInpusubjectroomno" class="form-label">Subject Name</label>
                                    <input type="text" name="sname" class="form-control" id="exampleInpusubjectname" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputfid" class="form-label">Branch ID</label>
                                    <input type="text" name="bid" class="form-control" id="exampleInputfid" required>
                                </div>
                                <div class="mb-3">
                                    <label for="enterdate" class="form-label">Semester</label>
                                    <input type="text" name="sem" class="form-control" id="enterdate" required><br>
                                    <center><button type="submit" class="btn btn-primary">ADD</button>
                                         <button type="submit" class="btn btn-primary" ><a href="viewsub.jsp" style="color: white;text-decoration: none">VIEW</a></button><br></center>
                                </div>                               
               </form>
                    </div>
                    </div>
