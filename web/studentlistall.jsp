    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
           ...
           <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">                
                ...
                <h3 class="text-primary" style="margin-left: auto;margin-right:auto"><span style="color: black">ALL</span> STUDENT <span style="color: black">LIST</span></h3>                               
                       </div>                                        
...
<%
           ...
           //String sem=request.getParameter("sem");
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                ResultSet res=stat.executeQuery("SELECT * FROM `candidatelist`");   
                while(res.next())
                {
                    slno++;
                         ...
                         out.println("<tr><td>"+slno+"</td><td>"+regno+"</td><td>"+name+"</td><td>"+bidd+"</td><td>"+semd+"</td><td>"+dob+"</td><td>"+phno+"</td><td>"+address+"</td><td>"+parentsphno+"</td><td><a href=deletest?id="+regno+">DELETE</a></td></tr>");                           
                        }
                }
