        ...
        <div class="content">
            ...
            <!-- Navbar End -->
                     ...
                     <div class="d-flex " style="padding: 20px">                          
                         <h3 class="text-primary" style="margin-left: auto;margin-right:auto">TIME <span style="color: black">TABLE</span></h3>                               
                       </div>
                    <div class="table-responsive">
                     ...
                     try{
                         ...
                         ResultSet res=stat.executeQuery("SELECT * FROM timetable");
                         while(res.next())
                         {                        
                         ...
                         String filepath=res.getString("filepath");
                          out.println("<tr><td>"+id+"</td><td>"+date+"</td><td>"+bid+"</td><td>"+sem+"</td><td>"+filepath+"</td><td><a href=deletetimetable?id="+id+">DELETE</a></td></tr>");
                            }
                         con.close();
                          }
                          catch(Exception e)
