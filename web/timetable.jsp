<%
    try{
        ...
        if(sid.equals("") ||password.equals("") ||sid.equals(null) ||password.equals(null))
        {
            ...
            out.println("<meta http-equiv='refresh' content='0;slogin.jsp'/>");
        }
    }
    catch(Exception e)
     {
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Form Start -->
            <div class="container-fluid pt-3 px-2" style="width: 80%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3"> 
                         <center><h3 class="mb-4 text-primary"><b>Time Table</b></h3></center>
                         <form action="timetable" method="POST">
                           
                             <%--  <div class="mb-3">
                                    <label for="enterid" class="form-label">File ID</label>
                                    <input type="text" name="id" class="form-control" id="enterid">
                                </div> --%>
                                <div class="mb-3">
                             ...
                             <div class="mb-3">
                                    <label for="enterbid" class="form-label">Branch ID</label>
                                    <input type="text" name="bid" class="form-control" id="entebid" required>
                                </div>
                             <div class="mb-3">
                                    <label for="entersem" class="form-label">Semester</label>
                                    <input type="text" name="sem" class="form-control" id="entersem" required>
                                </div>
                                <div class="mb-3">
                                    <label for="enterfilepath" class="form-label">File Path</label>
                                    <input type="file" name="filepath" class="form-control" id="enterfilepath" required><br>
                                <center>
                                    <button type="submit" class="btn btn-primary">ADD</button>        
                                    <button type="submit" class="btn btn-primary" ><a href="viewtimetables.jsp" style="color: white;text-decoration: none">VIEW</a></button>
                                </center>
                                </div>
                         </form>
