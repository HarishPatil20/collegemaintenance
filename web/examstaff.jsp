                ...
                <div class="navbar-nav w-100">
                     <a href="shome.jsp" class="nav-item nav-link  "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="#" class="dropdown-item">Exam Staff list</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3"> 
                    <center><h3 class="mb-4 text-primary">EXAM STAFF LIST</h3></center>
                            <form action="staffallotment" method="POST">
                           
                                
                                <div class="mb-3">
                                    <label for="exampleInputname" class="form-label">Batch Code</label>
                                    <input type="text" name="batchcode" class="form-control" id="exampleInputstudentname" required>
                                </div>
                                 <div class="mb-3">
                                    <label for="exampleInputbid" class="form-label">Sem</label>
                                    <input type="text" name="sem" class="form-control" id="exampleInputbid"required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputbid" class="form-label">Branch ID</label>
                                    <input type="text" name="bid" class="form-control" id="exampleInputbid" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputsemester" class="form-label">Subject Code</label>
                                    <input type="text" name="scode" class="form-control" id="exampleInputsemister" required>                                   
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputdate" class="form-label">Faculty ID</label>
                                    <input type="text" name="fid" class="form-control" id="exampleInputdate" required>
                                </div>
                                <center>
                                    <button type="submit" class="btn btn-primary">ADD</button>        
                                    <button type="submit" class="btn btn-primary" ><a href="examstafflists.jsp" style="color: white;text-decoration: none">VIEW</a></button>
                                </center>
                            </form>
                        </div>
                    </div>
