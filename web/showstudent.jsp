...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="nav-item dropdown">                   
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="examalloptmentg.jsp" class="dropdown-item">Exam Allotment</a>
  ...
  <%--
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                ResultSet res1=stat1.executeQuery("SELECT * FROM `branch` WHERE `bid`='"+bid+"' and `sem`='"+sem+"';");               
                while(res.next()){
                     ...
                     try{
                        ...
                        // Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/clgmaintenance","root","");
                         ...
                         String dob=res.getString("dob");
                          ...
                          out.println("<tr><td>"+regno+"</td><td>"+name+"</td><td>"+bid+"</td><td>"+sem+"</td><td>"+dob+"</td><td>"+phno+"</td><td>"+address+"</td><td>"+parentsphno+"</td></tr>");
                            }
                         con.close();
                          }
                          catch(Exception e)
