            ...
            <!-- Form Start -->
                 <div class="container-fluid pt-3 px-2" style="width: 60%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3"> 
                    ...
                    <form action="studentdte" method="POST" style="width: 100%;margin-left: auto;margin-right: auto">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleInputstudentname" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <!--<input type="text" name="Sem" class="form-control" id="exampleInputsemister">-->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="dob" class="form-control" id="exampleInputdate" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="textarea" name="address" class="form-control" id="exampleInputaddress" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputphno" class="form-label">Parents PH.NO</label>
                                    <input type="number" name="parentsphno" class="form-control" id="exampleInputparentsphno" required>
                                </div>
                        <div style="margin-left: auto;margin-right: auto">
                                <button type="submit" class="btn btn-primary">ADD</button>
                                <button type="submit" class="btn btn-primary" ><a href="stlists.jsp" style="color: white;text-decoration: none">VIEW</a></button>
                        </div>
                            </form>
                        </div>
