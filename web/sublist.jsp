    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-6 pb-4">
            <nav class="navbar bg-light navbar-light">
                <a href="#" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i ></i>ADMIN</h3>
                </a>
        ...
        <div class="content">
           ...
           <div class="container-fluid pt-3 px-2" style="width: 100%;margin-left: auto;margin-right: auto">                
                ...
                <h3 class="text-primary" style="margin-left: auto;margin-right:auto">SUBJECT <span style="color: black">LIST</span></h3>                               
                       </div>                                        
...
<%
           ...
           String sem=request.getParameter("sem");
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                ResultSet res=stat.executeQuery("SELECT * FROM `subject` WHERE `bid`='"+bid+"' and `sem`='"+sem+"';");   
                //out.println("SELECT * FROM `candidatelist` WHERE `bid`='"+bid+"' and `sem`='"+sem+"';");   
                while(res.next()){
                    slno++;
                    ...
                    String semd=res.getString("sem");     
                          out.println("<tr><td>"+slno+"</td><td>"+scode+"</td><td>"+sname+"</td><td>"+bidd+"</td><td>"+semd+"</td><td><a href=deletesubject?id="+scode+">DELETE</a></td></tr>");                           
          ...
          %>
           ...
           <center> <button type="submit" class="btn btn-primary" ><a href="sublistall.jsp" style="color: white;text-decoration: none">VIEW ALL</a></button></center>  
            <!-- Recent Sales End -->
