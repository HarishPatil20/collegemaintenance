...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4" style="padding: 15px">
                    ...
                    <div class="table-responsive">
                     ...
                     try{int slno=0;
                         ...
                         ResultSet res=stat.executeQuery("SELECT * FROM faculty WHERE `bid`='"+bid+"';");
                         while(res.next())
                         {            
                           slno++;   
                        ...
                        String joiningdate=res.getString("joiningdate");
                          ...
                          out.println("<tr><td>"+slno+"</td><td>"+fid+"</td><td>"+bidd+"</td><td>"+name+"</td><td>"+phno+"</td><td>"+designation+"</td><td>"+joiningdate+"</td><td><a href=deletefaculty?id="+fid+">DELETE</a></td></tr>");
                            }
                         con.close();
                          }
                          catch(Exception e)
