            ...
            <!-- Form Start -->
             <div class="container-fluid pt-3 px-2" style="width: 60%;margin-left: auto;margin-right: auto">
                  <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3" >  
                    <center><h3 class="mb-4 text-primary">FACULTY</h3></center>
                            <form action="addfaculty" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInpusubjectroomno" class="form-label">Name</label>
                                    <input type="text" name="name" class="form-control" id="exampleInpusubjectroomno" required>
                                </div>
                               <!--<div class="mb-3">
                                    <label for="exampleInputbid" class="form-label">Branch ID</label>
                                    <input type="text" name="bid" class="form-control" id="exampleInputbidid" required>
                                </div>-->
                               <label for="exampleInputbid" class="form-label">Branch ID</label>
                                ...
                                <select class="form-select" name="bid" id="floatingSelect" aria-label="Floating label select example" required>
                                    ...
                                    <option value="308CS">308CS</option>
                                    <option value="308CV">308CV</option>
                                    <option value="308ME">308ME</option>
                                    <option value="308E&E">308E&E</option>
                                    <option value="308EC">308EC</option>
                                </select>
                                    <label for="floatingSelect">Select Branch ID</label>
                                 </div>
                                 <div class="mb-3">
                                    <label for="exampleInputphno" class="form-label">PH.NO</label>
                                    <input type="number" name="phno" class="form-control" id="exampleInputphno" required>
                                </div>
                                <div class="mb-3">
                                   <label for="exampleInputdesignation" class="form-label">Designation</label>
                                    <input type="text" name="designation" class="form-control" id="exampleInputdesignation" required>  
                                </div>
                                <div class="mb-3">
                                    <label for="enterdate" class="form-label">Joining Date</label>
                                    <input type="date" name="joiningdate" class="form-control" id="enterdate" required><br>                      
                                    <center><button type="submit" class="btn btn-primary">ADD</button>
                                        <button type="submit" class="btn btn-primary" ><a href="facultylista.jsp" style="color: white;text-decoration: none">VIEW</a></button></center>
                        </div>
               </form>
                  </div>
                    </div>
